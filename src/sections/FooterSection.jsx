  ...
  return (
    <section className="footer-section">
      ...
      <div className="2xl:h-[110dvh] relative md:pt-[20vh] pt-[10vh]">
        ...
        {isMobile ? <img src="/images/footer-drink.png" className="absolute top-0 object-contain" /> : <video src="/videos/splash.mp4" autoPlay playsInline muted className="absolute top-0 object-contain mix-blend-lighten" />}
